...
# LM Studio'nun host makinedeki adresi
LM_STUDIO_URL = "http://host.docker.internal:1234/v1"

@app.route('/status', methods=['GET'])
def durum_kontrolu():
    """Honeypot arayüzündeki 'Bağlantıyı Test Et' butonu için durum kontrolü."""
    try:
...
def ai_sor():
    """Honeypot'tan gelen komutları LM Studio'ya ileten korumalı uç nokta."""
    ...
    # TIKANIKLIK GİDERİLDİ: Artık istekler ihtiyaca göre esnek token ve temperature alabilir.
    # Varsayılan değerler uzun raporlar ve kodlar için artırıldı.
    ...
    try:
        ...
        # HATA AYIKLAMA: LM Studio yanıt vermezse Docker loglarında hatayı doğrudan görebilmen için
